<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Services Overview') }}
        </h2>
        <!-- Toastr CSS -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
        <!-- Breadcrumbs and Add Button -->
        <div class="flex justify-end">
            <a href="{{ route('admin.our-service.create') }}"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">Services List</h3>
                                ...
                                @foreach ($our_services as $service)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('admin.our-service.edit', $service->id) }}"
                                                class="text-blue-500 hover:text-blue-700">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.our-service.destroy', $service->id) }}"
