        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100 mb-5">Edit About Us Details</h3>
                    ...
                    <form action="{{ route('admin.about.update', $aboutUs->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="heading" id="heading" 
                                       value="{{ old('heading', $aboutUs->heading) }}" 
                        ...
                        <div class="mt-6 flex justify-between items-center">
                            ...
                            <a href="{{ route('admin.about.adminview') }}" 
